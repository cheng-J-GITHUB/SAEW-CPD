...
def get_args():
    ...
    parser.add_argument('-bdd', '--base-dataset-dir', type = str, help = 'base dataset dir', dest = 'base_dataset_dir', default = '/media/lthpc/hd_auto/Liu/caozhijuan/zcj/FlowCD/klcpd-test2/data/')
